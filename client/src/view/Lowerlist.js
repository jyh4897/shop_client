...
import styles from './Lowerlist.module.css'
...
const Lowerlist = () => {
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                ...
                const sortedProd = [...prodData].sort((a, b) => Number(a.price) - Number(b.price));
    ...
    const handleChangePage = (page) => {
        const newUrl = `/shop/${categoryid}/3/${page}`;
        navigate(newUrl);
        setCurrentPage(page)
    }
        ...
        <div className={styles.listcontainer}>
            ...
            <div className={styles.listnavbar}>
                ...
                <ul className={styles.orderlist}>
                    ...
                    <li onClick={goLower}><strong>낮은가격순</strong></li>
                    <li onClick={goHigher}>높은가격순</li>
                </ul>
            </div>
